! function(e, t) {
    ...
    var D, L, O, N, U, J, K, q, V, j, Y, W, G, Q, X, r = (ScrollSmoother.register = function register(e) {
        return L || (D = e || t(), s() && window.document && (O = window, N = document, U = N.documentElement, J = N.body), D && (K = D.utils.toArray, q = D.utils.clamp, Y = D.parseEase("expo"), Q = D.core.context || function() {}, X = D.delayedCall(.2, function() {
            return V.isRefreshing || j && j.refresh()
        }).pause(), V = D.core.globals().ScrollTrigger, D.core.globals("ScrollSmoother", ScrollSmoother), J && V && (W = V.core._getVelocityProp, G = V.core._inputObserver, ScrollSmoother.refresh = V.refresh, L = 1))), L
    ...
    function ScrollSmoother(t) {
        ...
        function Ea(e) {
            return arguments.length ? (e < 0 && (e = 0), I.y = -e, d = !0, u ? H = -e : Da(-e), V.isRefreshing ? i.update() : R(e / _), this) : -H
        }
        ...
        function Ja() {
            Aa(), requestAnimationFrame(Aa), b && (b.forEach(function(e) {
                var t = e.start,
        ...
        function Oa(r, e, t, n, o) {
            ...
            var i, s, a, l, c, u, f = Na("speed", e, n, r),
                ...
                m = [],
                v = 0;
            return Eb(), (1 !== i || a || l) && (Jb(s = V.create({
                ...
                onUpdate: function onUpdate(e) {
                    var t, r, n, o = d + v * (e.progress - c),
                        i = p.length,
                        s = 0;
                    if (e.offset) {
                        if (i) {
                            for (r = -H, n = e.end; i--;) {
                                if ((t = p[i]).trig.isActive || r >= t.start && r <= t.end) return void(l && (t.trig.progress += t.trig.direction < 0 ? .001 : -.001, t.trig.update(0, 0, 1), l.resetTo("y", parseFloat(g.y), -A, !0), F && l.progress(1)));
                        ...
                        }(o + u), m.length && !a && m.forEach(function(e) {
                            return e(o - s)
                        }), l ? (l.resetTo("y", o, -A, !0), F && l.progress(1)) : (g.y = o + "px", g.renderTransform(1))
                    }
                }
            })), D.core.getCache(s.trigger).stRevert = Ma, s.startY = d, s.pins = p, s.markers = m, s.ratio = i, s.autoSpeed = a, r.style.willChange = "transform"), s
        }
        var n, S, e, i, b, s, a, l, c, u, r, f, h, d, g, p = t.smoothTouch,
            m = t.onUpdate,
            v = t.onStop,
            w = t.smooth,
            T = t.onFocusIn,
        ...
        function refreshHeight() {
            return e = n.clientHeight, n.style.overflow = "visible", J.style.height = O.innerHeight + (e - O.innerHeight) / _ + "px", e - O.innerHeight
        }
        Ka(), V.addEventListener("killAll", Ka), D.delayedCall(.5, function() {
            return F = 0
        }), this.scrollTop = Ea, this.scrollTo = function(e, t, r) {
            ...
            if (arguments.length) {
                ...
                return t !== n && (c = (n = t).getAttribute("style") || "", z && z.observe(n), D.set(n, {
                    overflow: "visible",
                    width: "100%",
            ...
            }(n), l = S.getAttribute("style") || "", refreshHeight(), D.set(S, k ? {
                overflow: "hidden",
                position: "fixed",
                height: "100%",
                width: "100%",
        ...
        B.forEach(function(e) {
            ...
            onRefreshInit: function onRefreshInit(e) {
                ...
                var r = e.getTween();
                h = r && r._end > r._dp._time, f = H, I.y = 0, k && (1 === V.isTouch && (S.style.position = "absolute"), S.scrollTop = 0, 1 === V.isTouch && (S.style.position = "fixed"))
            },
            onRefresh: function onRefresh(e) {
                e.animation.invalidate(), e.setPositions(e.start, refreshHeight() / _), h || Ca(e), I.y = -R() * _, Da(I.y), F || e.animation.progress(D.utils.clamp(0, 1, f / _ / -e.end)), h && (e.progress -= .001, e.update()), ScrollSmoother.isRefreshing = !1
            },
            id: "ScrollSmoother",
            scroller: O,
        ...
        }, i.getTween() && (i.getTween().vars.ease = t.ease || Y), this.scrollTrigger = i, t.effects && this.effects(!0 === t.effects ? "[data-" + P + "speed], [data-" + P + "lag]" : t.effects, {
            ...
            return arguments.length ? (!!u !== e && (e ? (i.getTween() && i.getTween().pause(), R(-H / _), M.reset(), (r = V.normalizeScroll()) && r.disable(), (u = V.observe({
                preventDefault: !0,
            ...
            })).nested = G(U, "wheel,touch,scroll", !0, !1 !== t)) : (u.nested.kill(), u.kill(), u = 0, r && r.enable(), i.progress = (-H / _ - i.start) / (i.end - i.start), Ca(i))), this) : !!u
        }, this.kill = this.revert = function() {
            o.paused(!1), Ca(i), i.kill();
            for (var e = (b || []).concat(s || []), t = e.length; t--;) e[t].kill();
            V.scrollerProxy(S), V.removeEventListener("killAll", Ka), V.removeEventListener("refresh", Ja), S.style.cssText = l, n.style.cssText = c;
            var r = V.defaults({});
            r && r.scroller === S && V.defaults({
                scroller: O
            }), o.normalizer && V.normalizeScroll(!1), clearInterval(a), j = null, z && z.disconnect(), J.style.removeProperty("height"), O.removeEventListener("focusin", Ha)
        }, this.refresh = function(e, t) {
            return i.refresh(e, t)
        }, E && (this.normalizer = V.normalizeScroll(!0 === E ? {
            debounce: !0,
            content: !k && n
        } : E)), V.config(t), "overscrollBehavior" in O.getComputedStyle(J) && D.set([J, U], {
            overscrollBehavior: "none"
        }), "scrollBehavior" in O.getComputedStyle(J) && D.set([J, U], {
            scrollBehavior: "auto"
        }), O.addEventListener("focusin", Ha), a = setInterval(ya, 250), "loading" === N.readyState || requestAnimationFrame(function() {
            return V.refresh()
        })
    }
